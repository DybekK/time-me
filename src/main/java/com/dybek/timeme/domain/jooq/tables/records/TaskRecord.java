...
public class TaskRecord extends UpdatableRecordImpl<TaskRecord> implements Record4<UUID, UUID, UUID, String> {
    ...
    @Override
    public TaskRecord values(UUID value1, UUID value2, UUID value3, String value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TaskRecord(UUID id, UUID workspaceUserId, UUID workspaceId, String title) {
        super(Task.TASK);
